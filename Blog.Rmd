...
author: "Lukas Kuld and Sara Mitchell"
...
grid.arrange(p2, p1, ncol=2, top=ggpubr::text_grob("Fig. 1: Number of writers nearby over time and by age/cohort", size=14))
```
